...
1. Use [navigation item](/salt/components/navigation-item) to build the horizontal page navigation, as explained in the [navigation pattern](./navigation).
...
3. Use a stack layout to position the [vertical navigation](./navigation) and utilities within the drawer.
